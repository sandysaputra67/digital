    ...
    <div class="grid grid-cols-12">
        ...
        <div class="col-span-3">
            <div class="grid grid-cols-2">
                <a href="{{ route('cart.index', $restaurant->id) }}" class="px-1 py-2 text-center text-gray-700 hover:text-gray-700" id="headerCart">
                ...
                <a href="{{ route('restaurant.show-qr', $restaurant->id) }}" class="px-1 py-2 text-center text-gray-700" id="headerScan">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 m-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
