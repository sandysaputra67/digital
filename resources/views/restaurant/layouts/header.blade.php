            ...
            <form method="GET">
                <div class="relative text-gray-500 focus-within:text-gray-500">
                    ...
                    <input type="text" name="q"
                        class="py-2 pl-10 pr-2 w-full text-lg text-gray-500 bg-white rounded focus:outline-none focus:bg-white focus:text-gray-900"
                        placeholder="Cari makanan" autocomplete="off">
                </div>
            </form>
        </div>
